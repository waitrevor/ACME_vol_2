...
LABS=("BinaryTrees" "BreadthFirstSearch" "CVXPY_Intro" "Exceptions_FileIO" "FourierTransform" "GradientMethods" "InteriorPoint_Linear" "LinkedLists" "MarkovChains" "NMF" "NearestNeighbor" "PolynomialInterpolation" "RegularExpressions" "Simplex" "UnixShell2" "Wavelets")
